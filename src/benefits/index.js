...
const isoImage = 'https://res.cloudinary.com/dhahnivds/image/upload/c_scale,f_auto,q_auto,w_922/v1601100355/WashTech/iso-certified-plants_3x.png'
...
export default function Benefits () {
  return <Section
    ...
    containerStyle={{ paddingTop: document.documentElement.clientWidth > 960 ? 80 : 48 }}
    items={items} />
}

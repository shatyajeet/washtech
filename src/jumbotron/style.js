...
export const JumbotronContainer = styled.div`
  background: url("https://res.cloudinary.com/dhahnivds/image/upload/f_auto,q_auto,h_640/v1599491621/WashTech/banner-image-desktop_2x.png")
    no-repeat center;
  background-size: cover;
  display: flex;
  height: 720px;
  justify-content: center;
  padding: 250px ${CONTENT_PADDING}px 150px;
  position: relative;
  @media screen and (max-width: 960px) {
    background: url("https://res.cloudinary.com/dhahnivds/image/upload/c_scale,f_auto,q_auto,w_720/v1599491590/WashTech/banner-image_3x.png")
      no-repeat center;
    background-size: cover;
    height: auto;

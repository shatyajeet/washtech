...
export default function Jumbotron() {
  ...
  function handleGetQuoteClick() {
    ...
    fetch("https://washtechtemp.tk/auth/addQuote", {
      ...
      .then((res) => {
        if (res.code !== 500) {
          setMessage(
            "Prepare to get the best laundry service for your business. Our team will get back to you shortly."
          );
          setIsModalOpen(true);
          clearFields();
        } else {
  ...
  return (
    <JumbotronContainer id="jumbotron">
      <JumbotronContent>
        <QuoteContainer id="quote-box" height={height} width={width}>
          <div>
            <ContentLine color="#FFF" textAlign="center">
              Premium laundry for your business
            </ContentLine>
            <SizedBox height={8} />
            <ContentHeading color="#12b07e" textAlign="center">
              <span style={{ fontWeight: 300 }}>We deliver</span> trust in every
              wash
            </ContentHeading>
            <SizedBox height={8} />
          </div>
